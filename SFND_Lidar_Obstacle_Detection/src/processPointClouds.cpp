                                         ...
                                         float distanceThreshold)
{
  ...
  // these coefficients are the parameters of the plane that we are trying to fit to the point cloud
  ...
  // we have found the inliers, now we need to separate the cloud into inliers and outliers
